  ...
  return (
    <>
      <Navbar classNameName='' expand="lg" variant="light" bg="light" >
        <DownloadTableExcel className="nav-option" filename="history_visite" sheet="hisotry_visite" currentTableRef={tableRef.current}>
