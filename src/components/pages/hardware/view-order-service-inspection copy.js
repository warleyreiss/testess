...
function HardwareListInspection() {
  ...
  useEffect(() => {
    axiosApi.get("/hardware/list_order_service_inspection")
      .then((response) => {
  ...
  const form = (formContent) => {
    ...
    navigate("/hardware/inspection/" + equipamento_id)
  }
    ...
    <>
      <div className="w-head-option" expand="lg" style={{ backgroundColor: '#12192C', color: 'white' }} >
        <Stack className='w-head-hstack' direction="horizontal" gap={2}>
          <div className="p-2 w-head-hstack-p2"><span className='w-head-option-title'>EQUIPAMEMTOS PARA INSPEÇÃO</span></div>
...
export default HardwareListInspection